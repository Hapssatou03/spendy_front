    ...
    <div className="home-wrapper">
      <main className="home-main">
        ...
        <div className="home-right">
          <img
            src={imagehomePageSpendy}
            alt="Couple heureux gérant ses finances"
          />
        </div>
      </main>
      ...
      <section className="home-features">
        <div className="feature-card">
          ...
          <p>
            Gardez un œil sur vos dépenses grâce à des outils de suivi
            détaillés.
          </p>
        </div>
        <div className="feature-card">
          ...
          <p>
            Définissez vos objectifs d’épargne et suivez votre progression
            facilement.
          </p>
        </div>
        <div className="feature-card">
          ...
          <p>
            Partagez la gestion de vos finances avec un membre de votre famille.
          </p>
        </div>
      </section>
